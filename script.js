...
(function () {
  ...
  function syncScenes() {
    ...
    if (els.sceneLabel) els.sceneLabel.textContent = SCENES[getSceneIndex(getProgress())];
  }
  ...
  function makeBrowserTexture(title, accent) {
    ...
    var line1 = (window.I18N && window.I18N.t("canvas.line1")) || "Hero sekcija • CTA • Responsive layout";

    var line2 = (window.I18N && window.I18N.t("canvas.line2")) || "Custom dizajn • Brzo učitavanje • 3D efekti";

    ctx.fillText(line1, 28, 140);

    ctx.fillText(line2, 28, 162);
    ...
    ctx.fillText((window.I18N && window.I18N.t("canvas.cta")) || "Pogledaj", 48, 213);
  ...
  function initThree() {
    ...
    var browserDefs = [
      ...
      { title: (window.I18N && window.I18N.t("canvas.business")) || "Biznis Sajt", accent: "#818cf8", pos: [-4, 2, -12],  rot: 0.5,  w: 2.6, h: 1.6 },
